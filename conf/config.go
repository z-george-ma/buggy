// Package conf contains utility to load environment variable / file content into a strong type
package conf
...
// LoadConfig reads config from environment / mounted secret volume
//
// Example:
//
//	type Config struct {
//		MyConnStr         string `env:"MY_CONN_STR"`
